...
3. **В том случае если вы администратор** вам доступна вкладка ADMIN PANEL. Тут во вкладках users available, topics, users banned вам доступна информация о действующих пользователях, обсуждениях и забаненных пользователях. Вы можете банить или разбанивать пользователей и обсуждения. Учетная запись администратора создается вручную путем редактирования столбца user_level в таблице users (0 - обычный пользователь, 1 - администратор).
